        ...
        mysql.query(sql, null, function (err, rows) {
            ...
            if (!err) {
                var params = [
                    ...
                    'Business Expense - Advertising & Marketing',
                    'Business Expense - Bank Fees',
                    'Business Expense - Hosting Services',
                    'Business Expense - Misc',
                    'Business Expense - Professional Fees',
                    'Business Expense - Salaries & Payroll',
                    'Business Expense - Taxes, State and Local',
                    'Business Expense - Taxes, Federal',
                    'Business Income',
                    'Business Transfer',
